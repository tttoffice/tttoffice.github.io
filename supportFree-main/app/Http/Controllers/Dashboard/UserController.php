...
class UserController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $users=User::whereRoleIs('editor')->when($request->search, function($query) use($request){//why use use($request)? to access request from this outside scope
    ...
    public function store(Request $request)
    {
        ...
        $user->attachRole('editor');//get this from laratrust_seeders.php
        //dd($request->permissions);
        //dd($user->syncPermissions($request->permissions));
