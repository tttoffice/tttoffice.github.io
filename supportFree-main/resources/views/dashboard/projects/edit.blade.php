               ...
               <form action="{{ route('dashboard.projects.update' , $project->id)}}" method="POST" enctype="multipart/form-data" >
                    ...
                    @foreach (config('translatable.locales') as $locale)
                        <div class="form-group">
                            ...
                            {{--ar[name]--}}
                            <input type="text" name="{{$locale}}[title]" class="form-control" value="{{$project->translate($locale)->title}} " >
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            {{--ar[name]--}}
                            <input type="text" name="{{$locale}}[content]" class="form-control" value="{{$project->translate($locale)->content}} " >
                        </div>
